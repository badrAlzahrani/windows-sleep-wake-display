...
function Read-WakeTime {
    ...
    while ($true) {
        ...
        Write-Host "Examples:  00:20   03:00   22:30" -ForegroundColor DarkGray
        $raw = Read-Host "  >"
        try {
...
function Show-Status {
    ...
    Write-Host "=== Armed wake timers ===" -ForegroundColor Cyan
    powercfg /waketimers
}
...
function Show-Menu {
    ...
    Write-Host "==================================================" -ForegroundColor Blue
    Write-Host "  1.  Install wake task"
    Write-Host "  2.  Show status"
    Write-Host "  3.  Test (dry-run)"
    Write-Host "  4.  Disable / Enable (toggle)"
    Write-Host "  5.  Uninstall (delete)"
    Write-Host "  6.  Exit"
    Write-Host "==================================================" -ForegroundColor Blue
}
